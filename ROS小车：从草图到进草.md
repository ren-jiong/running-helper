...
# 1.0 硬件部分
##  1.1 电源-基础姿态控制板需求
原本这仅仅包含最底层的电机驱动电路，但为了减少使用的电路板个数，所以我需要将尽可能多的功能集成到尽可能小的板子上，当我完成电源方面的原理图设计的时候，发现板子上还有剩下许多空间，所以我就将小车的基础姿态控制的电路也加入了进来。二者相结合，就变成了机器人的第一块电路板——电源-基础姿态控制板。由于考虑到今后可能还会用这一块板子做很多其他的事情，所以我尽可能地使用了全部的接口同时将尽可能多的元器件放置在板子上。
### 1.1.1 电机及其驱动
