...
void oled_show(void)
{
	  ...
	  //=============第三行显示角速度与距离===============//	
		...
		if(Motor_Left<0)		  OLED_ShowString(16,30,"-"),
													OLED_ShowNumber(26,30,myabs((int)Motor_Left),3,12);
		if(Motor_Left>=0)	    OLED_ShowString(16,30,"+"),
		                      OLED_ShowNumber(26,30,myabs((int)Motor_Left),3,12);
		...
		if(Motor_Right<0)		  OLED_ShowString(16,40,"-"),
													OLED_ShowNumber(26,40,myabs((int)Motor_Right),3,12);
		if(Motor_Right>=0)	  OLED_ShowString(16,40,"+"),
		                      OLED_ShowNumber(26,40,myabs((int)Motor_Right),3,12);
		...
		if(Flag_Stop)         OLED_ShowString(85,50,"OFF");
		if(!Flag_Stop)        OLED_ShowString(85,50,"ON ");
